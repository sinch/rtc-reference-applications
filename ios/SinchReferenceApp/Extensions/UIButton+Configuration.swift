...
extension UIButton.SinchButtonConfiguration {
  ...
  static let call = UIButton.SinchButtonConfiguration(backgroundColor: UIButton.Constant.callBackgroundColor,
                                                      image: UIImage(systemName: "phone"))

  static let hangup = UIButton.SinchButtonConfiguration(backgroundColor: UIButton.Constant.hangupBackgroundColor,
                                                        image: UIImage(systemName: "phone.down"))
}
