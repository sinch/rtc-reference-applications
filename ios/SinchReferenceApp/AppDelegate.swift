...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationWillEnterForeground(_ application: UIApplication) {
        ...
        transitionToCallView(activeCall)
    }
    ...
    // https://developers.sinch.com/docs/in-app-calling/ios/push-notifications-callkit/#configuring-an-apns-authentication-signing-key
...
extension AppDelegate: SinchManagedPushDelegate {
    ...
    func managedPush(_ managedPush: SinchRTC.SinchManagedPush,
                     ...
                     for type: String) {
        os_log("Received imcomming push notification with payload: %{public}@",
...
extension AppDelegate: SinchClientMediatorDelegate {
    ...
    private func transitionToCallView(_ call: SinchCall) {
        ...
        let presentingViewController = call.details.isVideoOffered
            ...
            : prepareAudioCallViewController(for: call, presentedViewController: presentedViewController)
    ...
    private func prepareAudioCallViewController(for call: SinchCall,
                                                presentedViewController: UIViewController) -> AudioCallViewController? {
        let audioCallViewController = presentedViewController.prepareViewController(identifier: "call") as? AudioCallViewController
